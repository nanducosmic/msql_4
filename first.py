...
print("Grocerry Bill")
print("Price for 3kg rice:"+str(total_Rice))
print("Price for 2.5kg sugar:"+str(total_Sugar))
print("Price for 1.8kg oil:"+int(total_Oil))
print("Total price:"+int(sub_Total))
print("Delivery charge:"+int(delivery_charge))
